...
const Banner = () => {
  return (
    <div id="default-carousel" className="relative" data-carousel="static ">
      <div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-screen">
        <div
        ...
        >
          ...
          <img
            ...
            alt="..."
          />
          <div className="carousel-caption hidden md:block absolute top-1/2 left-1/3 text-center">
            <h5 className="text-7xl font-light text-white">THE POERTY OF LOVE</h5>
          </div>
        </div>
        <div
